...
import { studio, navigation, galleryCategories } from '../data/siteData.js';
  ...
  {studioLocations.map((loc) => (
    <li key={loc.city}>
      ...
      >
        ...
        <span className="border-b border-brass/40 group-hover:border-brass-bright transition-colors duration-200">
          {loc.city}
        </span>
      </Link>
    </li>
